...
void testMe(){  
  ...
  std::string testName = "";
    ...
    { // 1: 
      ...
      if (game.isWin()){
        ...
        std::cout << "Failed test #" << testNum << " because isWin() returned false." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 3: 
      ...
      if (!game.isWin()){ // isWin() should test for the current player only which should be #0, even through #1 has won
        ...
        std::cout << "Failed test #" << testNum << " because isWin() returned TRUE." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 4: Bad Move on full board (1st input is always column 1 from testMeiIn.txt)
      ...
      if (!isGoodMove){
        ...
        std::cout << "Failed test #" << testNum << " because takeTurn() returned TRUE." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 5: GOOD Move on nearly board (1st input is always column 1 from testMeiIn.txt)
      ...
      if (isGoodMove){
        ...
        std::cout << "Failed test #" << testNum << " because takeTurn() returned FALSE." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 6: 
      ...
      if (game.isTie()){
        ...
        std::cout << "Failed test #" << testNum << " because isTie() returned FALSE." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 7: Complex: Not tie test
      ...
      if (!game.isTie()){
        ...
        std::cout << "Failed test #" << testNum << " because isTie() returned true." << std::endl;
        testResults[testNum] = false;
      }
    }
  ...
  { // 8: NextPlayer Test
      ...
      if (game.getCurrentPlayerToken() == y){
        ...
        std::cout << "Failed test #" << testNum << " because getCurrentPlayerToken() did not return the 2nd player's token correctly (out of 2 players)." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 9: NextPlayer Test
      ...
      if (game.getCurrentPlayerToken() == x) {
        ...
        std::cout << "Failed test #" << testNum << " because getCurrentPlayerToken() did not return the 1st player's token correctly (out of 2 players)." << std::endl;
        testResults[testNum] = false;
      }
    }
    ...
    { // 10: NextPlayer Test
      ...
      if (game.getCurrentPlayerToken() == x) {
        ...
        std::cout << "Failed test #" << testNum << " because getCurrentPlayerToken() did not return the 1st player's token correctly (out of 3 players)." << std::endl;
        testResults[testNum] = false;
      }
    }
  ...
  { // 12: getCurrentPlayerToken Test using 4th argument of constructor
      ...
      if (game.getCurrentPlayerToken() == z) {
        ...
        std::cout << "Failed test #" << testNum << " because getCurrentPlayerToken() did not return the 3rd player's token correctly (out of 3 players)." << std::endl;
        testResults[testNum] = false;
      }
    }
...
{ // 13: 
      ...
      inFile.seekg(0, std::ios::beg); 
      testNum++; // increment to the next test
      testName = "Diagonal UP-Right NOT-Win (3 players correct player, but not a win)";
      std::cout << std::endl << "***********************" << std::endl;
      std::cout << "Starting Test #" << testNum << ": " << testName << std::endl;
      char e = '*';
      char x = 'P';
    ...
    { // 14: 
      ...
      inFile.seekg(0, std::ios::beg); 
      testNum++; // increment to the next test
      testName = "3 player tie full board ";
      std::cout << std::endl << "***********************" << std::endl;
      std::cout << "Starting Test #" << testNum << ": " << testName << std::endl;
      char e = '*';
      char x = 'P';
    ...
    { // Bonus 0: Hard: Full Board tie test
      ...
      if (game.isTie()){
        ...
        std::cout << "Failed bonus test #" << bonusTestNum << " because isTie() returned FALSE." << std::endl;
    ...
    { // Bonus 2: Hard: Nearly Full Board IS TIE test
      ...
      if (!game.isTie()){
        ...
        std::cout << "Failed bonus test #" << bonusTestNum << " because isTie() returned true." << std::endl;
        bonusTestResults[bonusTestNum] = false;
      }
    }
